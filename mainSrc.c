/* Author: Fabio Bombace
 *
 * This source code runs a PIC16F1825 microcontroller as a pianola.
 * The microcontroller must have 7 metal piece attached (each of them in one capacitive sensor port) as key.
 */
